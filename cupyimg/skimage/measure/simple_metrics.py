...
__all__ = ["compare_mse", "compare_nrmse", "compare_psnr"]


def compare_mse(im1, im2):
    warn(
        "DEPRECATED: skimage.measure.compare_mse has been moved to "
...
def compare_nrmse(im_true, im_test, norm_type="euclidean"):
    warn(
        "DEPRECATED: skimage.measure.compare_nrmse has been moved to "
...
if normalized_root_mse.__doc__ is not None:
    compare_nrmse.__doc__ = (
        normalized_root_mse.__doc__
        + """
    Warns
    -----
    Deprecated:
...
if peak_signal_noise_ratio.__doc__ is not None:
    compare_psnr.__doc__ = (
        peak_signal_noise_ratio.__doc__
        + """
    Warns
    -----
    Deprecated:
