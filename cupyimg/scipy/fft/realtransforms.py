...
_mult_factor_dct2 = cupy.core.ElementwiseKernel(
...
def _dct_or_dst_type2(
    ...
    Args:
        ...
        forward (bool): Set true to indicate that this is a forward DCT-II as
            opposed to an inverse DCT-III (The difference between the two is only
...
_mult_factor_dct3 = cupy.core.ElementwiseKernel(
    in_params="R xr, int32 N, R norm_factor",
    out_params="C y",
    operation="""
    C j(0., 1.);
